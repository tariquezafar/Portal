...
namespace Portal.Core.ViewModel
{
   public class STRViewModel
    ...
    public class STRProductDetailViewModel
    {
        public long STRProductDetailId { get; set; }
        public long STRId { get; set; }
    ...
    public class STRSupportingDocumentViewModel
    {
        public int DocumentSequenceNo { get; set; }
        public long STRDocId { get; set; }
    ...
    public class STRProductSerialDetailViewModel
    {
        public long STRDetailId { get; set; }
        public long STRId { get; set; }
        public long ProductId { get; set; }
        public string ProductName { get; set; }
        public string ProductCode { get; set; }
