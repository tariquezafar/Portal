...
{
   public class FinishedGoodProcessViewModel
    {      
   ...
   public class FinishedGoodProcessProductViewModel
    {
    ...
    public class FinishedGoodProcessChasisSerialViewModel
    {
        public long FinishedGoodProcessChasisId { get; set; }
        public int FinishedGoodProcessId { get; set; }
        public int ProductId { get; set; }
