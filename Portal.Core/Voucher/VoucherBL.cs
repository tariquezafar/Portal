  ...
  public class VoucherBL
    {
        ...
        public ResponseOut AddEditBankVoucher(VoucherViewModel voucherViewModel, List<VoucherDetailViewModel> voucherEntryList, List<VoucherSupportingDocumentViewModel> voucherDocuments)
        {
            ...
            try
            {
                ...
                List<VoucherSupportingDocument> voucherDocumentList = new List<VoucherSupportingDocument>();
                if (voucherDocuments != null && voucherDocuments.Count > 0)
                {
                    foreach (VoucherSupportingDocumentViewModel item in voucherDocuments)
                    {
                        voucherDocumentList.Add(new VoucherSupportingDocument
                        {
                ...
                responseOut = sqlDbInterface.AddEditBankVoucher(voucher, voucherDetail, voucherDocumentList);
        ...
        public List<VoucherViewModel> GetBankVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId,int companyBranchId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetBankVoucherList( bookId, voucherMode, voucherNo,  voucherStatus,  fromDate, toDate, companyId, companyBranchId);
        ...
        public DataTable GenerateBankVoucherReports(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId,int companyBranchId)
        {
            ...
            try
            {
                dtVoucher = sqlDbInterface.GenerateBankVoucherReports(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId, companyBranchId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        //    return dtSTN;
        //}
        public DataTable GetBankVoucherDetailDataTable(long voucherId = 0)
        {
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            DataTable dtVoucher = new DataTable();
            try
        ...
        public DataTable GetBankVoucherEntryListDataTable(long voucherId)
        {
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            DataTable dtVoucherEntryList = new DataTable();
            try
            {
                dtVoucherEntryList = sqlDbInterface.GetBankVoucherEntryDetail(voucherId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        public List<VoucherViewModel> GetApprovedBankVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId,int companyBranchId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetApprovedBankVoucherList(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId, companyBranchId);
        ...
        public ResponseOut CancelApprovedBankVoucher(VoucherViewModel voucherViewModel)
        {
            ResponseOut responseOut = new ResponseOut();
            try
            {
                ...
                responseOut = dbInterface.CancelApprovedBankVoucher(voucher);
            }
            catch (Exception ex)
            {
                responseOut.status = ActionStatus.Fail;
        ...
        public List<VoucherSupportingDocumentViewModel> GetVoucherSupportingDocumentList(long voucherId)
        {
            List<VoucherSupportingDocumentViewModel> voucherDocuments = new List<VoucherSupportingDocumentViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtDocument = sqlDbInterface.GetVoucherSupportingDocumentList(voucherId);
        ...
        public DataTable LegerReportPrint(string billNo, string fromDate, string toDate)
        {
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            DataTable dtVoucher = new DataTable();
            try
            {
                dtVoucher = sqlDbInterface.GetFADeatilBillNoWise(billNo,Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate));
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
