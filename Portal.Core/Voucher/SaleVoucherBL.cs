...
{
  public class SaleVoucherBL
    {
        DBInterface dbInterface;
        public SaleVoucherBL()
        {
            dbInterface = new DBInterface();
        }


        public List<VoucherDetailViewModel> GetSaleVoucherEntryList(long voucherId)
        {
            List<VoucherDetailViewModel> voucherEntries = new List<VoucherDetailViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVoucherEntry = sqlDbInterface.GetSaleVoucherEntryDetail(voucherId);
