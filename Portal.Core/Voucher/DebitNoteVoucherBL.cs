...
{
  public class DebitNoteVoucherBL
    {
        DBInterface dbInterface;
        public DebitNoteVoucherBL()
        {
            dbInterface = new DBInterface();
        }
        public List<VoucherDetailViewModel> GetDebitNoteVoucherEntryList(long voucherId)
        {
            List<VoucherDetailViewModel> voucherEntries = new List<VoucherDetailViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVoucherEntry = sqlDbInterface.GetDebitNoteVoucherEntryDetail(voucherId);
        ...
        public ResponseOut AddEditDebitNoteVoucher(VoucherViewModel voucherViewModel, List<VoucherDetailViewModel> voucherEntryList,List<VoucherSupportingDocumentViewModel> debitNotevoucherDocuments)
        {
            ...
            try
            {
                ...
                List<VoucherSupportingDocument> debitNotevoucherDocumentList = new List<VoucherSupportingDocument>();
                if (debitNotevoucherDocuments != null && debitNotevoucherDocuments.Count > 0)
                {
                    foreach (VoucherSupportingDocumentViewModel item in debitNotevoucherDocuments)
                    {
                        debitNotevoucherDocumentList.Add(new VoucherSupportingDocument
                        {
                ...
                responseOut = sqlDbInterface.AddEditDebitNoteVoucher(voucher, voucherDetail, debitNotevoucherDocumentList);
        ...
        public List<VoucherViewModel> GetDebitNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId,int companyBranchId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetDebitNoteVoucherList( bookId, voucherMode, voucherNo,  voucherStatus,  fromDate, toDate, companyId, companyBranchId);
        ...
        public List<VoucherViewModel> GetApprovedDebitNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId,int companyBranchId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetApprovedDebitNoteVoucherList(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId, companyBranchId);
        ...
        public VoucherViewModel GetDebitNoteVoucherDetail(long voucherId = 0)
        {
            VoucherViewModel voucher = new VoucherViewModel();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVoucher = sqlDbInterface.GetDebitNoteVoucherDetail(voucherId);
        ...
        public DataTable GetDebitNoteVoucherDetailDataTable(long voucherId = 0)
        {
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
        ...
        public DataTable GetDebitNoteVoucherEntryListDataTable(long voucherId)
        {
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            DataTable dtVoucherEntryList = new DataTable();
            try
            {
                dtVoucherEntryList = sqlDbInterface.GetDebitNoteVoucherEntryDetail(voucherId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        public ResponseOut CancelApprovedDebitNoteVoucher(VoucherViewModel voucherViewModel)
        {
            ResponseOut responseOut = new ResponseOut();
            try
            {
                ...
                responseOut = dbInterface.CancelApprovedDebitNoteVoucher(voucher);
            }
            catch (Exception ex)
            {
                responseOut.status = ActionStatus.Fail;
        ...
        public List<VoucherSupportingDocumentViewModel> GetDebitNoteVoucherSupportingDocumentList(long voucherId)
        {
            List<VoucherSupportingDocumentViewModel> voucherDocuments = new List<VoucherSupportingDocumentViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtDocument = sqlDbInterface.GetDebitNoteVoucherSupportingDocumentList(voucherId);
        ...
        public DataTable GenerateDebitNoteVoucherReports(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId,int companyBranchId)
        {
            ...
            try
            {
                dtVoucher = sqlDbInterface.GenerateDebitNoteVoucherReports(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId, companyBranchId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
