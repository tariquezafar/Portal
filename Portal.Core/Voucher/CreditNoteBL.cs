...
namespace Portal.Core
{
    public class CreditNoteVoucherBL
    {
        ...
        public List<VoucherViewModel> GetCreditNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId,int companyBranchId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetCreditNoteVoucherList(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId, companyBranchId);
        ...
        public List<VoucherViewModel> GetApprovedCreditNoteVoucherList(Int32 bookId, string voucherMode, string voucherNo, string voucherStatus, DateTime fromDate, DateTime toDate, int companyId,int companyBranchId)
        {
            List<VoucherViewModel> vouchers = new List<VoucherViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtVouchers = sqlDbInterface.GetApprovedCreditNoteVoucherList(bookId, voucherMode, voucherNo, voucherStatus, fromDate, toDate, companyId, companyBranchId);
