...
,                        });
        ...
        public ResponseOut AddEditMRN(MRNViewModel mrnViewModel, List<MRNProductDetailViewModel> mrnProducts, List<MRNSupportingDocumentViewModel> mrnDocuments)
        {
            ...
            try
            {
                ...
                responseOut = sqlDbInterface.AddEditMRN(mrn, mrnProductList, mrnDocumentList);
        ...
        public List<MRNViewModel> GetMRNList(string mrnNo, string vendorName, string dispatchrefNo, string fromDate, string toDate, int companyId,string approvalStatus="",string companyBranch="")
        {
            List<MRNViewModel> mrns = new List<MRNViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtMRNs = sqlDbInterface.GetMRNList(mrnNo, vendorName, dispatchrefNo, Convert.ToDateTime(fromDate), Convert.ToDateTime(toDate), companyId, approvalStatus, companyBranch);
        ...
        public List<PurchaseInvoiceViewModel> GetPIList(string piNo, string vendorName, string refNo, string fromDate, string toDate, int companyId, string approvalStatus = "", string displayType = "", string vendorCode = "")
        {
            List<PurchaseInvoiceViewModel> pos = new List<PurchaseInvoiceViewModel>();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                DataTable dtPIs = sqlDbInterface.GetPIList(piNo, vendorName, refNo, fromDate, toDate, companyId, approvalStatus, displayType, vendorCode);
        ...
        public ResponseOut CancelMRN(MRNViewModel mrnViewModel)
        {
            ResponseOut responseOut = new ResponseOut();
            SQLDbInterface sqlDbInterface = new SQLDbInterface();
            try
            {
                ...
                responseOut = sqlDbInterface.CancelMRN(mrn);
            }
            catch (Exception ex)
            {
                responseOut.status = ActionStatus.Fail;
