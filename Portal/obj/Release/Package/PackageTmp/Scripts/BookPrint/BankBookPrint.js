...
$(document).ready(function () {
    ...
    //BindBookTypeList();
    var url = "../BookPrint/BankBookReport?bookName=" + $("#ddlBook  option:selected").text() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&CompanyBranch=" + $("#ddlCompanyBranch  option:selected").text() + "&CompanyBranchId=" + $("#ddlCompanyBranch").val() + "&reportType=PDF";
    $('#btnPrintPDF').attr('href', url);
    url = "../BookPrint/BankBookReport?bookName=" + $("#ddlBook  option:selected").text() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&CompanyBranch=" + $("#ddlCompanyBranch  option:selected").text() + "&CompanyBranchId=" + $("#ddlCompanyBranch").val() + "&reportType=Excel";
...
function ClearFields() {
    ...
    var url = "../BookPrint/BankBookReport?bookName=" + $("#ddlBook  option:selected").text() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&reportType=PDF";
    $('#btnPrintPDF').attr('href', url);
    url = "../BookPrint/BankBookReport?bookName=" + $("#ddlBook  option:selected").text() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&reportType=Excel";
    $('#btnPrintExcel').attr('href', url);
...
function SearchBankVoucher() {
    ...
    $.ajax({
        url: "../BookPrint/BankBookGenerate",
        cache: false,
        type: "POST",
        dataType: "json",
