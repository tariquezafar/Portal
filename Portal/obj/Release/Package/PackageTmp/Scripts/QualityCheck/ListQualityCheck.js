...
function ClearFields() {
    ...
    window.location.href = "../QualityCheck/ListQualityCheck";
...
function SearchQC() {
    ...
    var requestData = {
        qualityCheckNo: txtQualityCheckNo.val().trim(), gateInNo: txtGateInNo.val().trim(), poNo: txtPoNo.val().trim(),
        fromDate: txtFromDate.val(), toDate: txtToDate.val(), approvalStatus: ddlApprovalStatus.val(),companyBranch: ddlCompanyBranch.val()
    };
    $.ajax({
        url: "../QualityCheck/GetQualityCheckList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
