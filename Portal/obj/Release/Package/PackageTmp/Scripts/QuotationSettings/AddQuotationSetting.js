$(document).ready(function () {
    ...
    var hdnQuotationSettingId = $("#hdnQuotationSettingId");
    if (hdnQuotationSettingId.val() != "" && hdnQuotationSettingId.val() != "0" && hdnAccessMode.val() != "" && hdnAccessMode.val() != "0") {
        GetQuotationSettingDetail(hdnQuotationSettingId.val());
...
function GetQuotationSettingDetail(quotationsettingId) {
    $.ajax({
        type: "GET",
        asnc: false,
        url: "../QuotationSettings/GetQuotationSettingDetail",
        data: { quotationsettingId: quotationsettingId },
        dataType: "json",
        success: function (data) { 
            ...
            if (data.QuotationSetting_Status == true) {
...
function SaveData() {
    ...
    var quotationsettingViewModel = {
        QuotationSettingId: hdnQuotationSettingId.val(),
        ...
        QuotationSetting_Status: chkstatus 
    };
    var requestData = { quotationsettingViewModel: quotationsettingViewModel };
    $.ajax({
        url: "../QuotationSettings/AddEditQuotationSetting",
        cache: false,
        type: "POST",
        dataType: "json",
