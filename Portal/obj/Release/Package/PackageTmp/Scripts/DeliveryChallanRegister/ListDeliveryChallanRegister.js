...
function ClearFields() {
    ...
    //$("#txtCustomerName").val("");
    //$("#txtCreatedBy").val("");
    //$("#ddlSortBy").val("E.ChallanNo");
    //$("#ddlSortOrder").val("ASC");
    //$("#txtFromDate").val($("#hdnFromDate").val());
    //$("#txtToDate").val($("#hdnToDate").val());
    //$("#ddlState").val(0);
    window.location.href = "../DeliveryChallanRegister/ListDeliveryChallanRegister";
    
}
function SearchDeliveryChallanRegister() {
    ...
    $.ajax({
        url: "../DeliveryChallanRegister/GetDeliveryChallanRegisterList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
