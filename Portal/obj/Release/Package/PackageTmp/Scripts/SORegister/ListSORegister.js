...
function ClearFields() { 
    //$("#txtCustomerName").val(""); 
    //$("#ddlSortBy").val("E.SONo");
    //$("#ddlSortOrder").val("ASC");
    //$("#txtFromDate").val($("#hdnFromDate").val());
    //$("#txtToDate").val($("#hdnToDate").val());
    //$("#ddlState").val(0);
    window.location.href = "../SORegister/ListSORegister";
    
}
function SearchSORegister() {
    ...
    $.ajax({
        url: "../SORegister/GetSORegisterList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
