...
.autocomplete("instance")._renderItem = function (ul, item) {
    ...
    //SearchEmployeeClaimApplication();
...
function SearchEmployeeClaimApplication() {
    ...
    var requestData = {
        applicationNo: txtApplicationNo.val().trim(), employeeId: hdnEmployeeId.val(), claimTypeId: ddlClaimType.val(),
        claimStatus: ddlClaimStatus.val(), fromDate: txtFromDate.val(), toDate: txtToDate.val(),
        essEmployeeId: hdnEssEmployeeId.val(), essEmployeeName: hdnEssEmployeeName.val(), companyBranchId: ddlCompanyBranch.val()
    };
    $.ajax({
        url: "../EmployeeClaimApplication/GetEmployeeClaimApplicationList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
