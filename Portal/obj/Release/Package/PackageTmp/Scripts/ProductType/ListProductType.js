...
function SearchProductType() { 
    ...
    var requestData = { producttypeName: txtProductTypeName.val().trim(), producttypeCode: txtProductTypeCode.val().trim(), producttypeStatus: ddlStatus.val(), companyBranchId: 0 };
    $.ajax({
