...
function ClearFields()
{
    ...
    //$("#txtMotorNo").val("");
    //$("#txtControllerNo").val("");
    window.location.href = "../ChasisSerialMapping/ListChasisSerial";

    
    
}
function SearchChasisSerialMapping() {
    ...
    var ddlSerialStatus = $("#ddlSerialStatus");

    var requestData = { productId: hdnProductId.val().trim(), ChasisSerialNo: txtChasisSerialNo.val().trim(), MotorNo: txtMotorNo.val().trim(), ControllerNo: txtControllerNo.val().trim(), companyBranchId: ddlCompanyBranch.val(), serialStatus: ddlSerialStatus.val() };
    $.ajax({
