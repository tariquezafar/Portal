...
function GenerateReportParameters() {
    var url = "../ChasisSerialPlan/ChassisNoTrackingDetailedReport?chasisNo=" + $("#txtChasisNo").val() + "&reportType=PDF";
    $('#btnPdf').attr('href', url);
    var url = "../ChasisSerialPlan/ChassisNoTrackingDetailedReport?&chasisNo=" + $("#txtChasisNo").val() + "&reportType=Excel";
