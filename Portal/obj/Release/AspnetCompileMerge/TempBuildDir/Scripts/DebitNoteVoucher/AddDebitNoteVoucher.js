  ...
  .autocomplete("instance")._renderItem = function (ul, item) {
   ...
   // BindBookTypeList();
    ...
    if (hdnVoucherId.val() != "" && hdnVoucherId.val() != "0" && hdnAccessMode.val() != "" && hdnAccessMode.val() != "0") {
        setTimeout(
       function () {
           GetDebitNoteVoucherDetail(hdnVoucherId.val());
       }, 2000);
    ...
    GetDebitNoteVoucherEntryList(voucherEntryList);
    var debitNotelVoucherDocuments = [];
    GetDebitNoteVoucherDocumentList(debitNotelVoucherDocuments);
...
function GetDebitNoteVoucherDocumentList(debitNotelVoucherDocuments) {
    var hdnVoucherId = $("#hdnVoucherId");
    var requestData = { debitNotelVoucherDocuments: debitNotelVoucherDocuments, voucherId: hdnVoucherId.val() };
    $.ajax({
        url: "../DebitNoteVoucher/GetDebitNoteVoucherSupportingDocumentList",
        cache: false,
...
function SaveDocument() {
    ...
    $.ajax({
        url: "../DebitNoteVoucher/SaveSupportingDocument",
        type: "POST",
        asnc: false,
        ...
        success: function (result) {
            if (result.status == "SUCCESS") {
                ...
                GetDebitNoteVoucherDocumentList(voucherDocumentList);
...
function BindBookTypeList() {
    ...
    $.ajax({
        ...
        asnc: false,
        success: function (data) {
            $("#ddlBook").append($("<option></option>").val(0).html("-Select Debit Note Book-"));
            $.each(data, function (i, item) {
...
function GetDebitNoteVoucherDetail(voucherId) {
    $.ajax({
        type: "GET",
        asnc: false,
        url: "../DebitNoteVoucher/GetDebitNoteVoucherDetail",
...
function GetDebitNoteVoucherEntryList(voucherEntryList) {
    var hdnVoucherId = $("#hdnVoucherId");
    var requestData = { voucherEntryList: voucherEntryList, voucherId: hdnVoucherId.val() };
    $.ajax({
        url: "../DebitNoteVoucher/GetDebitNoteVoucherEntryList",
        cache: false,
        data: JSON.stringify(requestData),
        dataType: "html",
        contentType: "application/json; charset=utf-8",
...
function SaveData() {
    ...
    var debitNoteVoucherDocumentList = [];
    $('#tblDocumentList tr').each(function (i, row) {
        var $row = $(row);
        var voucherDocId = $row.find("#hdnVoucherDocId").val();
        var documentSequenceNo = $row.find("#hdnDocumentSequenceNo").val();
        ...
        if (voucherDocId != undefined) {
            ...
            debitNoteVoucherDocumentList.push(debitNotevoucherDocument);
        }
    ...
    var requestData = { voucherViewModel: voucherViewModel, voucherEntryList: voucherEntryList, debitNotevoucherDocuments: debitNoteVoucherDocumentList };
    $.ajax({
        url: "../DebitNoteVoucher/AddEditDebitNoteVoucher",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
                ...
                setTimeout(
                   function () {
                       if ($("#hdnStartInterface").val() == "") {
                           window.location.href = "../DebitNoteVoucher/AddEditDebitNoteVoucher?VoucherId=" + data.trnId + "&AccessMode=2";
                       }
                       else {
                           window.location.href = "../DebitNoteVoucher/AddEditDebitNoteVoucher?ReportLevel=" + $("#hdnReportLevel").val() + "&FromDate=" + $("#hdnDrillFromDate").val() + "&ToDate=" + $("#hdnDrillToDate").val() + "&StartInterface=" + $("#hdnStartInterface").val() + "&GLMainGroupId=" + $("#hdnGLMainGroupId").val() + "&GLSubGroupId=" + $("#hdnGLSubGroupId").val() + "&GLId=" + $("#hdnDrillGlId").val() + "&SLId=" + $("#hdnDrillSlId").val() + "&VoucherId=" + data.trnId + "&AccessMode=2";
                       }
                   }, 2000);
