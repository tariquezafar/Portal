...
function SearchFinishedGoodProcess() {
    ...
    var requestData = { finishedGoodProcessNo: txtFinishedGoodProcessNo.val(), workOrderNo: txtWorkOrderNo.val().trim(), companyBranchId: ddlCompanyBranch.val(), fromDate: txtFromDate.val(), toDate: txtToDate.val(), finishedGoodProcessStatus: ddlApprovalStatus.val() };
    $.ajax({
        url: "../FinishedGoodProcess/GetFinishedGoodProcessList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
