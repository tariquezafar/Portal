...
function SearchGL() {
    ...
    $.ajax({
        url: "../GL/GetGLMappingOpeningList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
...
function SelectGLMappingOpeningDetail(GLId, CompanyBranchId, OpeningBalance, OpeningBalanceCredit, OpeningBalanceDebit, GLHead)
{
    ...
    $("#ddlCompanyBranchopBal").val(CompanyBranchId);
...
function SaveData() {
    ...
    //if (txtOpeningBalance.val() == "" || txtOpeningBalance.val() == "0") {
    //    ShowModel("Alert", "Please enter Opening Balance")
    //    return false;
    //}
