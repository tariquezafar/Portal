...
function ClearFields() { 
    ...
    //$("#ddlToWarehouse").val("0");
    //$("#txtCreatedBy").val("");
    //$("#ddlSortBy").val("E.STNNo");
    //$("#ddlSortOrder").val("ASC");
    //$("#txtFromDate").val($("#hdnFromDate").val());
    //$("#txtToDate").val($("#hdnToDate").val());

    window.location.href = "../STNRegister/ListSTNRegister";
  
    
}
function SearchSTNRegister() { 
    ...
    var requestData = { stnNo: txtSTNNo.val().trim(), glNo: txtGRNo.val().trim(), fromLocation: ddlFromWarehouse.val(), toLocation: ddlToWarehouse.val(), fromDate: txtFromDate.val(), toDate: txtToDate.val(), createdBy: hdnCreatedId.val(), sortBy: ddlSortBy.val(), SortOrder: ddlSortOrder.val()};
    $.ajax({
        url: "../STNRegister/GetSTNRegisterList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
