...
.autocomplete("instance")._renderItem = function (ul, item) {
    ...
    //SearchApprovalEmployeeAssetApplication();
...
function SearchApprovalEmployeeAssetApplication() {
    ...
    var requestData = {
        ...
        assetStatus: ddlAssetStatus.val(), fromDate: txtFromDate.val(), toDate: txtToDate.val(), companyBranchId: ddlCompanyBranch.val()
    };
    $.ajax({
        url: "../EmployeeAssetApplication/GetEmployeeAssetApplicationApprovalList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
