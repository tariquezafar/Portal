...
.autocomplete("instance")._renderItem = function (ul, item) {
    ...
    //SearchEmployeeAssetApplication();
...
function ClearFields() {
    ...
    $("#ddlAssetStatus").val("0");
    $("#txtFromDate").val($("#hdnFromDate").val());
    $("#txtToDate").val($("#hdnToDate").val());
}

function SearchEmployeeAssetApplication() {
    ...
    var requestData = {
        applicationNo: txtApplicationNo.val().trim(), employeeId: hdnEmployeeId.val(), assetTypeName: ddlAssetType.val(),
        assetStatus: ddlAssetStatus.val(), fromDate: txtFromDate.val(), toDate: txtToDate.val(),
        essEmployeeId: hdnEssEmployeeId.val(), essEmployeeName: hdnEssEmployeeName.val(), companyBranchId: ddlCompanyBranch.val()
    };
    $.ajax({
        url: "../EmployeeAssetApplication/GetEmployeeAssetApplicationList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
