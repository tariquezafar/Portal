...
function SaveData() {
    ...
    $.ajax({
        url: "../PMS_EmployeeAppraisalTemplateMapping/AddEditEmployeeAppraisalTeamplateMapping?accessMode=" + accessMode + "",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                if (accessMode == 2) {
                    setTimeout(
                  function () {
                      window.location.href = "../PMS_EmployeeAppraisalTemplateMapping/ListEmployeeAppraisalTeamplateMapping";
                  }, 2000);
                }
                else {
                    setTimeout(
                    function () {
                        window.location.href = "../PMS_EmployeeAppraisalTemplateMapping/AddEditEmployeeAppraisalTemplateMapping";
                    }, 2000);
                }
            }
            else {
