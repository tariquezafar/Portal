...
function SearchUser() {
    ...
    var requestData = { userName: txtUserName.val().trim(), phoneNo: txtPhoneNo.val().trim(), fullName: txtFullName.val().trim(), email: txtEmail.val().trim(), roleId: ddlRole.val(), companyBranchId: ddlCompanyBranch.val() };
    $.ajax({
