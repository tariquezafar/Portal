...
function SaveData() {
    ...
    $.ajax({
        url: "../Voucher/AddEditBankVoucher",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../Voucher/AddEditBankVoucher?VoucherId=" + data.trnId + "&AccessMode=2";
                   }, 2000);
...
function CancelBankVoucher() {
    ...
    $.ajax({
        url: "../Voucher/CancelApprovedBankVoucher",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../Voucher/ListApprovedBankVoucher";
                   }, 2000);
