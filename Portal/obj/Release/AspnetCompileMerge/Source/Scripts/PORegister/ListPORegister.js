...
function ClearFields() { 
    //$("#txtVendorName").val("");
    //$("#txtCreatedBy").val("");
    //$("#ddlSortBy").val("E.PONo");
    //$("#ddlSortOrder").val("ASC");
    //$("#txtFromDate").val($("#hdnFromDate").val());
    //$("#txtToDate").val($("#hdnToDate").val());
    //$("#ddlState").val(0);
    window.location.href = "../PORegister/ListPORegister";
    
}
function SearchPORegister() { 
    ...
    var requestData = { vendorId: hdnVendorId.val(), stateId: ddlState.val(), fromDate: txtFromDate.val(), toDate: txtToDate.val(), createdBy: hdnCreatedId.val(), sortBy: ddlSortBy.val(), SortOrder: ddlSortOrder.val(),companyBranch: ddlCompanyBranch.val() };
    $.ajax({
        url: "../PORegister/GetPORegisterList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
...
//function Export() {
//    var divList = $("#divList");
//    if (divList.find('table').length > 0) {
//        ExporttoExcel(divList);
//    }
//    else {
//        // alert("No data to export");
//        ShowModel("Alert", "No data to export")
//    }
...
function GenerateReportParameters() {
    ...
    var url = "../PORegister/GeneratePORegisterReports?vendorId=" + $("#hdnVendorId").val() + "&stateId=" + $("#ddlState").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&createdBy=" + $("#hdnCreatedId").val() + "&sortBy=" + $("#ddlSortBy").val() + "&sortOrder=" + $("#ddlSortOrder").val() + "&companyBranch=" + $("#ddlCompanyBranch").val() +"&companyBranchName=" + $("#ddlCompanyBranch  option:selected").text() +"&reportType=PDF";
    $('#btnPdf').attr('href', url);
    url = "../PORegister/GeneratePORegisterReports?vendorId=" + $("#hdnVendorId").val() + "&stateId=" + $("#ddlState").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&createdBy=" + $("#hdnCreatedId").val() + "&sortBy=" + $("#ddlSortBy").val() + "&sortOrder=" + $("#ddlSortOrder").val() + "&companyBranch=" + $("#ddlCompanyBranch").val() + "&companyBranchName=" + $("#ddlCompanyBranch  option:selected").text() + "&reportType=Excel";
