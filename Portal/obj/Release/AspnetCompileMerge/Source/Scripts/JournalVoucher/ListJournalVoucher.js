...
function BindBookTypeList() {
    ...
    $.ajax({
        type: "GET",
        // url: "../JournalVoucher/GetBookList", Commeted BY Dheeraj 
...
function ClearFields() {
    ...
    window.location.href = "../JournalVoucher/ListJournalVoucher";
...
function SearchJournalVoucher() {
    ...
    if (ddlBook.val() == "" || ddlBook.val() == "0") {
        alert("Please select Journal Book")
        ddlBook.focus();
        return false;
    }
    ...
    $.ajax({
        url: "../JournalVoucher/GetJournalVoucherList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
...
function OpenPrintPopup() {
    var ddlBook = $("#ddlBook");
    if (ddlBook.val() == "" || ddlBook.val() == "0") {
        alert("Please Select Journal Note Book")
        return false;
    }
    else {
        $("#printModel").modal();
...
function GenerateReportParameters() {
    ...
    var url = "../JournalVoucher/GenerateJournalVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() +"&companyBranchId=" + $("#ddlCompanyBranch").val() + "&reportType=PDF";
    $('#btnPdf').attr('href', url);
    url = "../JournalVoucher/GenerateJournalVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&companyBranchId=" + $("#ddlCompanyBranch").val() +"&reportType=Excel";
