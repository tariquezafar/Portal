...
function SaveData() {
    ...
    var ddlCancelApprovalStatus = $("#ddlCancelApprovalStatus");
    ...
    var voucherViewModel = {
        ...
        VoucherStatus:ddlCancelApprovalStatus.val(),
        BookId: ddlBook.val()
    };
    ...
    $.ajax({
        url: "../JournalVoucher/CancelApprovedJournalVoucher",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../JournalVoucher/CancelApprovedJournalVoucher?VoucherId=" + data.trnId + "&AccessMode=2";
                   }, 2000);
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../JournalVoucher/ListApprovedJournalVoucher";
                   }, 2000);
