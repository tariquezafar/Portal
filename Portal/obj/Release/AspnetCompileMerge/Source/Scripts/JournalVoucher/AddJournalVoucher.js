 ...
 .autocomplete("instance")._renderItem = function (ul, item) {
  ...
  .autocomplete("instance")._renderItem = function (ul, item) {
   ...
   // BindBookTypeList();
    ...
    var journalVoucherDocuments = [];
    GetJournalVoucherDocumentList(journalVoucherDocuments);
...
function GetJournalVoucherDocumentList(journalVoucherDocuments) {
    var hdnVoucherId = $("#hdnVoucherId");
    var requestData = { journalVoucherDocuments: journalVoucherDocuments, voucherId: hdnVoucherId.val() };
    $.ajax({
        url: "../JournalVoucher/GetJournalVoucherSupportingDocumentList",
        cache: false,
...
function SaveDocument() {
    ...
    $.ajax({
        url: "../JournalVoucher/SaveSupportingDocument",
        type: "POST",
        asnc: false,
        ...
        success: function (result) {
            if (result.status == "SUCCESS") {
                ...
                GetJournalVoucherDocumentList(voucherDocumentList);
...
function BindBookTypeList() {
    ...
    $("#ddlBook").val(0);
    $("#ddlBook").html("");
    var requestData = { bookType: "JV", companyBranchId: companyBranchId };
    $.ajax({
        type: "GET",
        //url: "../JournalVoucher/GetBookList", Comment By Dheeraj Kumar
...
function GetBankVoucherEntryList(voucherEntryList) {
    ...
    $.ajax({
        url: "../JournalVoucher/GetJournalVoucherEntryList",
        cache: false,
        data: JSON.stringify(requestData),
        dataType: "html",
        contentType: "application/json; charset=utf-8",
...
function SaveData() {
    ...
    var journalVoucherDocumentList = [];
    $('#tblDocumentList tr').each(function (i, row) {
        var $row = $(row);
        var voucherDocId = $row.find("#hdnVoucherDocId").val();
        var documentSequenceNo = $row.find("#hdnDocumentSequenceNo").val();
        ...
        if (voucherDocId != undefined) {
            ...
            journalVoucherDocumentList.push(journalhvoucherDocument);
        }
    ...
    var requestData = { voucherViewModel: voucherViewModel, voucherEntryList: voucherEntryList, journalvoucherDocuments: journalVoucherDocumentList };
    $.ajax({
        url: "../JournalVoucher/AddEditJournalVoucher?accessMode=" + accessMode + "",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
