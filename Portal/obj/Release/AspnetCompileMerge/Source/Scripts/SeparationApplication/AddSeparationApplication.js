...
function SaveData() {
    ...
    $.ajax({
        url: "../SeparationApplication/AddEditSeparationApplication?accessMode=" + accessMode + "",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                if (accessMode == 2) {
                    setTimeout(
                  function () {
                      window.location.href = "../SeparationApplication/ListSeparationApplication";
                  }, 2000);
                }
                else {
                    setTimeout(
                    function () {
                        window.location.href = "../SeparationApplication/AddEditSeparationApplication";
                    }, 2000);
                }
            }
            else {
