$(document).ready(function () {
    ...
    $("#txtPurchaseReturnNo").attr('readOnly', true);
    $("#txtPurchaseReturnDate").attr('readOnly', true);
    ...
    $("#txtVendorName").autocomplete({
        ...
        source: function (request, response) {
            $.ajax({
                url: "../PurchaseReturn/GetVendorAutoCompleteList",
                type: "GET",
                dataType: "json",
                data: { term: request.term },
                success: function (data) {
                    response($.map(data, function (item) {
                        return { label: item.VendorName, value: item.VendorId, primaryAddress: item.PrimaryAddress, code: item.VendorCode };
                    }))
                }
            })
        },
...
.autocomplete("instance")._renderItem = function (ul, item) {
    ...
    $("#txtPurchaseReturnDate,#txtLRDate,#txtDispatchRefDate,#txtRejectedDate,#txtCancelDate,#txtApprovalDate").datepicker({
        changeMonth: true,
        changeYear: true,
        dateFormat: 'dd-M-yy',
        yearRange: '-10:+100',
    ...
    var hdnPurchaseReturnId = $("#hdnPurchaseReturnId");
    if (hdnPurchaseReturnId.val() != "" && hdnPurchaseReturnId.val() != "0" && hdnAccessMode.val() != "" && hdnAccessMode.val() != "0")
    {
        setTimeout(
       function () {
           GetPurchaseReturnDetail(hdnPurchaseReturnId.val());
       ...
       var purchaseReturnProducts = [];
       GetPurchaseReturnProductList(purchaseReturnProducts);
    }
    else {
        $("#btnSave").show();
        $("#btnUpdate").hide();
...
function GetBranchStateId() {
    ...
    $.ajax({
        type: "GET",
        url: "../PurchaseReturn/GetCompanyBranchByStateIdList",
...
function AddProduct(action) {
    ...
    var hdnPurchaseReturnProductDetailId = $("#hdnPurchaseReturnProductDetailId");
    ...
    $('#tblProductList tr').each(function (i, row) {
        ...
        var purchaseReturnProductDetailId = $row.find("#hdnPurchaseReturnProductDetailId").val();
        ...
        if (productName != undefined) {
            if (action == 1 || (hdnSequenceNo.val() != sequenceNo)) {
                ...
                var purchaseReturnProduct = {
                    PurchaseReturnProductDetailId: purchaseReturnProductDetailId,
                ...
                purchaseReturnProductList.push(purchaseReturnProduct);
                productEntrySequence = parseInt(productEntrySequence) + 1;
            }
            else if (hdnProductId.val() == productId && hdnSequenceNo.val() == sequenceNo) {
                var purchaseReturnProduct = {
                    PurchaseReturnProductDetailId: hdnPurchaseReturnProductDetailId.val(),
    ...
    if (action == 1) {
        var purchaseReturnProductAddEdit = {
            PurchaseReturnProductDetailId: hdnPurchaseReturnProductDetailId.val(),
            SequenceNo: hdnSequenceNo.val(),
            ProductId: hdnProductId.val(),
            ProductName: txtProductName.val().trim(),
        ...
        purchaseReturnProductList.push(purchaseReturnProductAddEdit);
        hdnSequenceNo.val("0");
    }
    GetPurchaseReturnProductList(purchaseReturnProductList);

}
function GetPurchaseReturnProductList(purchaseReturnProducts) {
    var hdnPurchaseReturnId = $("#hdnPurchaseReturnId");
    var requestData = { purchaseReturnProducts: purchaseReturnProducts, purchaseReturnId: hdnPurchaseReturnId.val() };
    $.ajax({
        url: "../PurchaseReturn/GetPurchaseReturnProductList",
        cache: false,
...
function EditProductRow(obj) {
    ...
    $("#hdnPurchaseReturnProductDetailId").val(purchaseReturnProductDetailId);
...
function GetPurchaseReturnDetail(purchaseReturnId) {
    $.ajax({
        type: "GET",
        asnc: false,
        url: "../PurchaseReturn/GetPurchaseReturnDetail",
        data: { purchaseReturnId: purchaseReturnId },
        dataType: "json",
        success: function (data) {
            $("#txtPurchaseReturnNo").val(data.PurchaseReturnNo);
            $("#txtPurchaseReturnDate").val(data.PurchaseReturnDate);
...
function SaveData() {
    ...
    var hdnPurchaseReturnId = $("#hdnPurchaseReturnId");
    var txtPurchaseReturnDate = $("#txtPurchaseReturnDate");
    ...
    var ddlSVendorBranch = $("#ddlSVendorBranch"); 
    ...
    var purchaseReturnViewModel = {
        PurchaseReturnId: hdnPurchaseReturnId.val(),
        PurchaseReturnNo: txtPurchaseReturnNo.val().trim(),
        PurchaseReturnDate: txtPurchaseReturnDate.val().trim(),
    ...
    if (hdnPurchaseReturnId.val() != null && hdnPurchaseReturnId.val() != 0) {
        accessMode = 2;//Edit Mode
    }

    var requestData = { purchaseReturnViewModel: purchaseReturnViewModel, purchaseReturnProducts: purchaseReturnProductList };
    $.ajax({
        url: "../PurchaseReturn/AddEditPurchaseReturn?accessMode=" + accessMode + "",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../PurchaseReturn/AddEditPurchaseReturn?PurchaseReturnId=" + data.trnId + "&AccessMode=3";
                   }, 2000);
...
function GetProductAvailableStock(productId) {
    $.ajax({
        ...
        data: { productid: productId, companyBranchId: $("#ddlCompanyBranch").val(), trnId: $("#hdnPurchaseReturnId").val(), trnType: "DC" },
        dataType: "json",
        success: function (data) {
...
function validateStateSelection(action) {
    var hdnVendorStateId = $("#ddlSState");
    var hdnBillingStateId = $("#hdnBillingStateId");

    if (hdnVendorStateId.val() == "0") {
        ShowModel("Alert", "Please Select Consignee")
        return false;
    }
...
function SearchInvoice() {
    ...
    var ddlCompanyBranch =$("#ddlCompanyBranch");
    var requestData = { piNo: txtInvoiceNo.val().trim(), vendorName: txtVendorName.val().trim(), refNo: txtRefNo.val().trim(), fromDate: txtFromDate.val(), toDate: txtToDate.val(), approvalStatus: "Final", displayType: "Popup", companyBranchId: ddlCompanyBranch.val() };
    $.ajax({
        url: "../PurchaseReturn/GetPurchaseInvoiceList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
...
function SelectInvoice(invoiceId, invoiceNo, invoiceDate, vendorId, vendorCode, vendorName) {
   ...
   // GetConsigneeDetail(consigneeId);
    GetPurchaseInvoiceDetail(invoiceId);
    var purchaseinvoiceProducts = [];
    GetPurchaseInvoiceProductList(purchaseinvoiceProducts, invoiceId);
}


function GetPurchaseInvoiceProductList(purchaseinvoiceProducts, invoiceId) {
   
    var requestData = { piProducts: purchaseinvoiceProducts, invoiceId: invoiceId };
    $.ajax({
        url: "../PurchaseReturn/GetPurchaseReturnPIProductList",
        cache: false,
        data: JSON.stringify(requestData),
        dataType: "html",
        contentType: "application/json; charset=utf-8",
...
function GetPurchaseInvoiceTaxList(purchaseinvoiceTaxes, invoiceId) {
    var requestData = { purchaseinvoiceTaxes: purchaseinvoiceTaxes, purchaseinvoiceId: invoiceId };
    $.ajax({
...
function GetPurchaseInvoiceTermList(purchaseinvoiceTerms, invoiceId) {
    var requestData = { purchaseinvoiceTerms: purchaseinvoiceTerms, purchaseinvoiceId: invoiceId };
    $.ajax({
...
function GetPurchaseInvoiceDetail(invoiceId) {
    $.ajax({
        type: "GET",
        asnc: false,
        ...
        success: function (data) {
            //BindCompanyBranchList();
           // $("#ddlCompanyBranch").val(10004);
            $("#txtSAddress").val(data.ShippingAddress);
            ...
            $("#hdnBillingStateId").val(data.ShippingStateId);
    ...
    $('#tblProductList tr').each(function (i, row) {
        ...
        if (hdnProductId != undefined) {
            $.ajax({
                ...
                asnc: false,
                success: function (data) {
                    if (hdnVendorStateId.val() == hdnBillingStateId.val()) {
...
//    if(ddlInvoiceStatus.val() !="0")
//    {        
//        if (ddlInvoiceStatus.val() == "Approve") {
//            $("#divApprove").show();
...
//        }
//        if (ddlInvoiceStatus.val() == "Reject")
//        {
//            $("#divRejectResonStatus").show();
//            $("#divReject").show();
//        }
//        else
//        {
//            $("#divRejectResonStatus").hide();
//            $("#divReject").hide();
//        }
//        if (ddlInvoiceStatus.val() == "Cancel") {
//            $("#divCancelResonStatus").show();
//            $("#divCancel").show();
//        }
//        else {
//            $("#divCancelResonStatus").hide();
//            $("#divCancel").hide();
//        }
//    }
//    else {
