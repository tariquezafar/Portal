...
function BindBookTypeList() {
    var requestData = { bookType: "C" };
    $.ajax({
        type: "GET",
        url: "../CashVoucher/GetBookList",
        data: requestData,
        dataType: "json",
        asnc: false,
        success: function (data) {
...
function SaveData() {
    ...
    $.ajax({
        url: "../CashVoucher/AddEditCashVoucher",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                setTimeout(
                   function () {
                       window.location.href = "../CashVoucher/ListApprovedCashVoucher";
                   }, 2000);
