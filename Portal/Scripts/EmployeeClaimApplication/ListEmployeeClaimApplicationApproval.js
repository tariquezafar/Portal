...
.autocomplete("instance")._renderItem = function (ul, item) {
    ...
    //SearchApprovalEmployeeClaimApplication();
...
function SearchApprovalEmployeeClaimApplication() {
    ...
    var requestData = {
        ...
        claimStatus: ddlClaimStatus.val(), fromDate: txtFromDate.val(), toDate: txtToDate.val(), companyBranchId: ddlCompanyBranch.val()
    };
    $.ajax({
        url: "../EmployeeClaimApplication/GetEmployeeClaimApplicationApprovalList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
