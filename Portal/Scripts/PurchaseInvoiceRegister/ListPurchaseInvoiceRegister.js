...
function ClearFields() { 
    ...
    //$("#ddlState").val(0);
    window.location.href = "../PurchaseInvoiceRegister/ListPurchaseInvoiceRegister";
    
}
function SearchPurchaseInvoiceRegister() {
    ...
    $.ajax({
        url: "../PurchaseInvoiceRegister/GetPurchaseInvoiceRegisterList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
