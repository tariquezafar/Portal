...
function ClearFields() {
    ...
    window.location.href = "../BankStatement/ListBankStatement";


}
function SearchBankStatement() {
    var txtBankStatementNo = $("#txtBankStatementNo");
    ...
    var requestData = { bankStatementNo: txtBankStatementNo.val(), bankBookId: hdnBankBookId.val().trim(), companyBranchId: ddlCompanyBranch.val(), fromDate: txtFromDate.val(), toDate: txtToDate.val(), bankStatementStatus: ddlBankStatementStatus.val() };
    $.ajax({
        url: "../BankStatement/GetBankStatementList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
