...
function SearchPO() {
    ...
    var requestData = {
        poNo: txtPONo.val().trim(), vendorName: txtVendorName.val().trim(),
        refNo: txtRefNo.val().trim(), fromDate: txtFromDate.val(),
        toDate: txtToDate.val(), approvalStatus: ddlApprovalStatus.val(),
        CreatedByUserName: txtSearchCreatedBy.val(), companyBranch: ddlCompanyBranch.val(), pOType: ddlPOType.val()
    };
    $.ajax({
        url: "../PO/GetPOList",
        data: requestData,
