...
function BindBookTypeList() {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("#ddlBook").append($("<option></option>").val(0).html("-Select Debit Note-"));
...
function ClearFields() {
    ...
    window.location.href = "../DebitNoteVoucher/ListDebitNoteVoucher";
...
function SearchDebitNoteVoucher() {
    ...
    if (ddlBook.val() == "" || ddlBook.val() == "0") {
        alert("Please select Debit Note Book")
        ddlBook.focus();
        return false;
    }
    ...
    $.ajax({
        url: "../DebitNoteVoucher/GetDebitNoteVoucherList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
...
function GenerateReportParameters() {
    ...
    var url = "../DebitNoteVoucher/GenerateDebitNoteVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&companyBranchId=" + $("#ddlCompanyBranch").val() + "&reportType=PDF";
    $('#btnPdf').attr('href', url);
    url = "../DebitNoteVoucher/GenerateDebitNoteVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&companyBranchId=" + $("#ddlCompanyBranch").val() + "&reportType=Excel";
