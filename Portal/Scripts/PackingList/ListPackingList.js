...
function SearchPackingList() {
    ...
    var requestData = { packingListName: txtPackingListName.val(), packingListStatus: ddlPackingListStatus.val(), companyBranchId: ddlCompanyBranch.val() };
    $.ajax({
