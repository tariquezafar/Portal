...
function ClearFields() {
    ...
    window.location.href = "../MaterialRejectNote/ListMaterialRejectNote";
    
}
function SearchMaterialRejectNote() {
   
    var txtMaterialRejectNote = $("#txtMaterialRejectNote");
    ...
    var requestData = {
        materialReceiveNoteNo: txtMaterialRejectNote.val().trim(),
    ...
    $.ajax({
        url: "../MaterialRejectNote/GetMaterialRejectNoteList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
