...
function SearchLeaveType() {
    ...
    var requestData = { leavetypeName: txtleaveTypeName.val().trim(), leaveTypeCode: txtLeaveTypeCode.val().trim(), leavetypeStatus: ddlStatus.val() };
    $.ajax({
        url: "../LeaveType/GetLeaveTypeList",
        data: requestData, 
        dataType: "html",
        type: "GET",
        error: function (err) {
