        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                if ($("input[name='ReportLevel']:checked").val() == "MainGroup") {
                    window.location.href = "../TBDrillDown/MainGroupWiseTBDrillDown?ReportLevel=" + $("input[name='ReportLevel']:checked").val() + "&FromDate=" + txtFromDate.val() + "&ToDate=" + txtToDate.val() + "&companyBranchId=" + ddlCompanyBranch.val() + "&AccessMode=3";
                }
                else if ($("input[name='ReportLevel']:checked").val() == "SubGroup") {
                    window.location.href = "../TBDrillDown/SubGroupWiseTBDrillDown?ReportLevel=" + $("input[name='ReportLevel']:checked").val() + "&FromDate=" + txtFromDate.val() + "&ToDate=" + txtToDate.val() + "&companyBranchId=" + ddlCompanyBranch.val() + "&AccessMode=3";
                }
                else if ($("input[name='ReportLevel']:checked").val() == "GLWise") {
                    window.location.href = "../TBDrillDown/GLWiseTBDrillDown?ReportLevel=" + $("input[name='ReportLevel']:checked").val() + "&FromDate=" + txtFromDate.val() + "&ToDate=" + txtToDate.val() + "&companyBranchId=" + ddlCompanyBranch.val() + "&AccessMode=3";
                }
                else if ($("input[name='ReportLevel']:checked").val() == "SLWise") {
                    window.location.href = "../TBDrillDown/SLWiseTBDrillDown?ReportLevel=" + $("input[name='ReportLevel']:checked").val() + "&FromDate=" + txtFromDate.val() + "&ToDate=" + txtToDate.val() + "&companyBranchId=" + ddlCompanyBranch.val() + "&AccessMode=3";
                }
            }
            else {
