...
function ClearFields() {
    ...
    window.location.href = "../CashVoucher/ListCashVoucher";
...
function SearchCashVoucher() {
    ...
    $.ajax({
        url: "../CashVoucher/GetCashVoucherList",
        data: requestData,
        dataType: "html",
        type: "GET",
        error: function (err) {
...
function OpenPrintPopup() {
    var ddlBook = $("#ddlBook");
    if (ddlBook.val() == "" || ddlBook.val() == "0") {
        alert("Please select Cash Note Book")
        return false;
    }
    else {
        $("#printModel").modal();
...
function GenerateReportParameters() {
    ...
    var url = "../CashVoucher/GenerateCashVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&companyBranchId=" + $("#ddlCompanyBranch").val() + "&reportType=PDF";
    $('#btnPdf').attr('href', url);
    url = "../CashVoucher/GenerateCashVoucherReport?bookId=" + $("#ddlBook").val() + "&voucherMode=" + $("#ddlVoucherMode").val() + "&voucherNo=" + $("#txtVoucherNo").val() + "&voucherStatus=" + $("#ddlVoucherStatus").val() + "&fromDate=" + $("#txtFromDate").val() + "&toDate=" + $("#txtToDate").val() + "&companyBranchId=" + $("#ddlCompanyBranch").val() + "&reportType=Excel";
