 ...
 .autocomplete("instance")._renderItem = function (ul, item) {
  ...
  .autocomplete("instance")._renderItem = function (ul, item) {
    ...
    if (hdnVoucherId.val() != "" && hdnVoucherId.val() != "0" && hdnAccessMode.val() != "" && hdnAccessMode.val() != "0") {
        setTimeout(
       function () {
           GetCashVoucherDetail(hdnVoucherId.val());
       }, 2000);
    ...
    GetCashVoucherEntryList(voucherEntryList);
    var cashVoucherDocuments = [];
    GetCashVoucherDocumentList(cashVoucherDocuments);
...
function GetCashVoucherDocumentList(cashVoucherDocuments) {
    var hdnVoucherId = $("#hdnVoucherId");
    var requestData = { cashVoucherDocuments: cashVoucherDocuments, voucherId: hdnVoucherId.val() };
    $.ajax({
        url: "../CashVoucher/GetCashVoucherSupportingDocumentList",
        cache: false,
...
function SaveDocument() {
    ...
    $.ajax({
        url: "../CashVoucher/SaveSupportingDocument",
        type: "POST",
        asnc: false,
        ...
        success: function (result) {
            if (result.status == "SUCCESS") {
                ...
                GetCashVoucherDocumentList(voucherDocumentList);
...
function BindBookTypeList(trnValue) {
    ...
    $("#ddlBook").val(0);
    $("#ddlBook").html("");
    var requestData = { bookType: "C", companyBranchId: companyBranchId };
    $.ajax({
        type: "GET",
        ...
        asnc: false,
        success: function (data) {
            $("#ddlBook").append($("<option></option>").val(0).html("-Select Cash Voucher-"));
            $.each(data, function (i, item) {
...
function BindPaymentModeList() {
    ...
    $.ajax({
        type: "GET",
        url: "../CashVoucher/GetPaymentModeList",
        data: requestData,
        dataType: "json",
        asnc: false,
        success: function (data) {
...
function BindCostCenterList() {
    ...
    $.ajax({
        type: "GET",
        url: "../CashVoucher/GetCostCenterList",
        data: requestData,
        dataType: "json",
        asnc: false,
        success: function (data) {
...
function GetCashVoucherDetail(voucherId) {
    $.ajax({
        type: "GET",
        asnc: false,
        url: "../CashVoucher/GetCashVoucherDetail",
...
function GetCashVoucherEntryList(voucherEntryList) {
    var hdnVoucherId = $("#hdnVoucherId");
    var requestData = { voucherEntryList: voucherEntryList, voucherId: hdnVoucherId.val() };
    $.ajax({
        url: "../CashVoucher/GetCashVoucherEntryList",
        cache: false,
        data: JSON.stringify(requestData),
        dataType: "html",
        contentType: "application/json; charset=utf-8",
...
function SaveData() {
    ...
    $('#tblDocumentList tr').each(function (i, row) {
        ...
        if (voucherDocId != undefined) {
            ...
            cashVoucherDocumentList.push(cashvoucherDocument);
        }
    ...
    var requestData = { voucherViewModel: voucherViewModel, voucherEntryList: voucherEntryList, cashvoucherDocuments: cashVoucherDocumentList };
    $.ajax({
        url: "../CashVoucher/AddEditCashVoucher?accessMode=" + accessMode + "",
        cache: false,
        type: "POST",
        dataType: "json",
        data: JSON.stringify(requestData),
                ...
                setTimeout(
                   function () {
                       if ($("#hdnStartInterface").val() == "") {
                           window.location.href = "../CashVoucher/AddEditCashVoucher?VoucherId=" + data.trnId + "&AccessMode=2";
                       }
                       else {
                           window.location.href = "../CashVoucher/AddEditCashVoucher?ReportLevel=" + $("#hdnReportLevel").val() + "&FromDate=" + $("#hdnDrillFromDate").val() + "&ToDate=" + $("#hdnDrillToDate").val() + "&StartInterface=" + $("#hdnStartInterface").val() + "&GLMainGroupId=" + $("#hdnGLMainGroupId").val() + "&GLSubGroupId=" + $("#hdnGLSubGroupId").val() + "&GLId=" + $("#hdnDrillGlId").val() + "&SLId=" + $("#hdnDrillSlId").val() + "&VoucherId=" + data.trnId + "&AccessMode=2";
                       }
                   }, 2000);
...
function OpenNewCashBookPopup(bookType) {
