...
function SearchTDSSection() {
    ...
    var requestData = { sectionName: txtSectionName.val().trim(), sectionDesc: txtSectionDescription.val().trim(), sectionMAXValue: txtSectionMAXValue.val().trim(), Status: ddlStatus.val(),companyBranch: ddlCompanyBranch.val() };
    $.ajax({
        url: "../TDSSection/GetTDSSectionList",
        data: requestData, 
        dataType: "html",
        type: "GET",
        error: function (err) {
