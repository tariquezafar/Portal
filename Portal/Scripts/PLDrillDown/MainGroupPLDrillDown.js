...
function GenerateDrillDown() {
    ...
    $.ajax({
        url: "../PLDrillDown/PLDrillDownGenerate",
        cache: false,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            if (data.status == "SUCCESS") {
                ...
                if ($("input[name='ReportLevel']:checked").val() == "MainGroup") {
                    window.location.href = "../PLDrillDown/MainGroupWisePLDrillDown?ReportLevel=" + $("input[name='ReportLevel']:checked").val() + "&FromDate=" + txtFromDate.val() + "&ToDate=" + txtToDate.val() + "&companyBranchId=" + ddlCompanyBranch.val() + "&AccessMode=3";
                }
                else if ($("input[name='ReportLevel']:checked").val() == "SubGroup") {
                    window.location.href = "../PLDrillDown/SubGroupWisePLDrillDown?ReportLevel=" + $("input[name='ReportLevel']:checked").val() + "&FromDate=" + txtFromDate.val() + "&ToDate=" + txtToDate.val() + "&companyBranchId=" + ddlCompanyBranch.val() + "&AccessMode=3";
                }
                else if ($("input[name='ReportLevel']:checked").val() == "GLWise") {
                    window.location.href = "../PLDrillDown/GLWisePLDrillDown?ReportLevel=" + $("input[name='ReportLevel']:checked").val() + "&FromDate=" + txtFromDate.val() + "&ToDate=" + txtToDate.val() + "&companyBranchId=" + ddlCompanyBranch.val() + "&AccessMode=3";
                }
                else if ($("input[name='ReportLevel']:checked").val() == "SLWise") {
                    window.location.href = "../PLDrillDown/SLWisePLDrillDown?ReportLevel=" + $("input[name='ReportLevel']:checked").val() + "&FromDate=" + txtFromDate.val() + "&ToDate=" + txtToDate.val() + "&companyBranchId=" + ddlCompanyBranch.val() + "&AccessMode=3";
                }
            }
            else {
