...
namespace Portal.Controllers
{
    ...
    public class QuotationRegisterController : BaseController
    {
        ...
        [HttpGet]
        public PartialViewResult GetQuotationRegisterList( int customerId = 0, int stateId = 0, string fromDate = "", string toDate = "", int createdBy = 0 ,string sortBy="", string sortOrder = "",int companyBranchId=0)
        {
        ...
        public ActionResult GenerateQuotationRegisterReports(int customerId = 0, int stateId = 0, string fromDate = "", string toDate = "", int createdBy = 0, string sortBy = "", string sortOrder = "",int companyBranchId=0, string reportType = "PDF")
        {
            ...
            ReportDataSource rd = new ReportDataSource("QuotationRegisterReportsDataSet", quotationRegisterBl.GenerateQuotationRegisterReports(customerId, stateId, fromDate, toDate, ContextUser.CompanyId, createdBy, sortBy, sortOrder, companyBranchId));
