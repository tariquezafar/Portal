...
namespace Portal.Controllers
{
    ...
    public class ServiceInvoiceController : BaseController
    {
        ...
        [ValidateRequest(true, UserInterfaceHelper.Add_Edit_ServiceInvoice, (int)AccessMode.AddAccess, (int)RequestMode.GetPost)]
        public ActionResult AddEditServiceInvoice(int siId = 0, int accessMode = 0, int customerId = 0, string customerCode = "", string customerName = "")
        {
            try
            {
        ...
        [ValidateRequest(true, UserInterfaceHelper.Add_Edit_ServiceInvoice, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult ListServiceInvoice(string todayList = "false")
        {
            try
            {
                FinYearViewModel finYear = Session[SessionKey.CurrentFinYear] != null ? (FinYearViewModel)Session[SessionKey.CurrentFinYear] : new FinYearViewModel();
        ...
        [HttpGet]
        public PartialViewResult GetServiceInvoiceList(string saleinvoiceNo = "", string customerName = "", string refNo = "", string fromDate = "", string toDate = "", string invoiceType = "", string approvalStatus = "", int companyBranchId = 0, string saleType = "", string CreatedByUserName = "")
        {
            List<SaleInvoiceViewModel> saleinvoices = new List<SaleInvoiceViewModel>();
            SaleInvoiceBL saleinvoiceBL = new SaleInvoiceBL();
            try
            {
                saleinvoices = saleinvoiceBL.GetSaleInvoiceList(saleinvoiceNo, customerName, refNo, fromDate, toDate, ContextUser.CompanyId, invoiceType, "", approvalStatus, "", companyBranchId, saleType, CreatedByUserName, Convert.ToInt32(Session[SessionKey.CustomerId]),"Service");
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        [HttpGet]
        public JsonResult GetServiceInvoiceDetail(long saleinvoiceId)
        {
            SaleInvoiceBL saleinvoiceBL = new SaleInvoiceBL();
        ...
        [HttpPost]
        public PartialViewResult GetServiceInvoiceProductList(List<SaleInvoiceProductViewModel> saleinvoiceProducts, long saleinvoiceId)
        {
        ...
        [HttpPost]
        public PartialViewResult GetServiceInvoiceTaxList(List<SaleInvoiceTaxViewModel> saleinvoiceTaxes, long saleinvoiceId)
        {
            SaleInvoiceBL saleinvoiceBL = new SaleInvoiceBL();
            try
            {
        ...
        [HttpPost]
        public PartialViewResult GetServiceInvoiceTermList(List<SaleInvoiceTermViewModel> saleinvoiceTerms, long saleinvoiceId)
        {
            SaleInvoiceBL saleinvoiceBL = new SaleInvoiceBL();
            try
            {
        ...
        [HttpPost]
        public PartialViewResult GetServiceInvoiceProductSerialDetailList(List<SaleInvoiceProductSerialDetailViewModel> saleSerials, int saleinvoiceId = 0)
        {
            SaleInvoiceBL saleinvoiceBL = new SaleInvoiceBL();
            try
            {
        ...
        public PartialViewResult GetSaleOrderList(string soNo = "", string customerName = "", string refNo = "", string fromDate = "", string toDate = "", string approvalStatus = "", string displayType = "", int companyBranchId = 0)
        {
            ...
            try
            {
                soList = soBL.GetSOList(soNo, customerName, refNo, fromDate, toDate, ContextUser.CompanyId, approvalStatus, displayType, "", companyBranchId);
            }
            catch (Exception ex)
            {
                Logger.SaveErrorLog(this.ToString(), MethodBase.GetCurrentMethod().Name, ex);
        ...
        public ActionResult ReportForm(long siId, string reportType = "PDF", string reportOption = "Original")
        {
            LocalReport lr = new LocalReport();
            SaleInvoiceBL siBL = new SaleInvoiceBL();
            string path = Path.Combine(Server.MapPath("~/RDLC"), "ServiceInvoiceFormPrint.rdlc");
            if (System.IO.File.Exists(path))
            {
                lr.ReportPath = path;
            }
        ...
        public ActionResult ServiceInvoiceMail(long siId, string reportType = "PDF", string reportOption = "Original")
        {
            ResponseOut responseOut = new ResponseOut();
            LocalReport lr = new LocalReport();
            SaleInvoiceBL siBL = new SaleInvoiceBL();
        ...
        [ValidateRequest(true, UserInterfaceHelper.Add_Edit_CancelServiceInvoice, (int)AccessMode.CancelAccess, (int)RequestMode.GetPost)]
        public ActionResult CancelServiceInvoice(int siId = 0, int accessMode = 4)
        {
            try
            {
                FinYearViewModel finYear = Session[SessionKey.CurrentFinYear] != null ? (FinYearViewModel)Session[SessionKey.CurrentFinYear] : new FinYearViewModel();
        ...
        [HttpPost]
        [ValidateRequest(true, UserInterfaceHelper.Add_Edit_CancelServiceInvoice, (int)AccessMode.AddAccess, (int)RequestMode.Ajax)]
        public ActionResult CancelServiceInvoice(long invoiceId, string sINo, string cancelReason)
        {
            ResponseOut responseOut = new ResponseOut();
            SaleInvoiceBL saleinvoiceBL = new SaleInvoiceBL();
        ...
        public PartialViewResult SaveProductSerialDetail()
        {
            ...
            return PartialView("GetServiceInvoiceProductSerialDetailList", productSerialDetail);
        }
        ...
        [ValidateRequest(true, UserInterfaceHelper.Add_GETGSTR1, (int)AccessMode.ViewAccess, (int)RequestMode.GetPost)]
        public ActionResult ListServiceInvoiceCancelReport()
        {
            try
            {
                FinYearViewModel finYear = Session[SessionKey.CurrentFinYear] != null ? (FinYearViewModel)Session[SessionKey.CurrentFinYear] : new FinYearViewModel();
        ...
        public ActionResult ServiceInvoiceCancelReport(string cancelReportType, string fromDate, string toDate, string companyBranch, string customerName, string reportType = "PDF")
        {
            LocalReport lr = new LocalReport();
            SaleInvoiceBL saleInvoiceBL = new SaleInvoiceBL();
        ...
        [HttpPost]
        public PartialViewResult GetServiceInvoiceJobCardProductList(List<SaleInvoiceProductViewModel> saleinvoiceProducts, long jobCardID)
        {
            SaleInvoiceBL siBL = new SaleInvoiceBL();
            try
            {
